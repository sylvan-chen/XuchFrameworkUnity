...
namespace Framework.Core
{
    ...
    public class IapMgr : MonoSingleton<IapMgr>
    {
        [Header("支付平台")]
        [SerializeField]
        ...
        [Header("Catalog配置")]
        [SerializeField]
        private IAPProviderInitParams.CatalogSourceType _catalogType =
            IAPProviderInitParams.CatalogSourceType.UnityCatalog;
        ...
        private void OnPurchaseFinishedWrapper(string productId, bool succeed) =>
            OnPurchaseFinished.Invoke(productId, succeed);
        ...
        protected override void OnInitialize()
        {
            ...
            _provider.Initialize(
                new IAPProviderInitParams { CatalogType = _catalogType, CustomJsonPath = _customJsonPath }
            );
        }
