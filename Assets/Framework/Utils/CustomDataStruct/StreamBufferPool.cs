...
namespace CustomDataStruct
{
    ...
    public sealed class StreamBuffer : IDisposable
    {
        ...
        {
            if (!canWrite && size <= 0)
                throw new Exception("bufferSize must > 0 when can not write");
        ...
        public MemoryStream memStream
        {
            ...
            {
                if (!canRead && !canWrite)
                    throw new Exception("The stream buffer can not read and can not write!");
                if (mMemStream == null)
        ...
        public BinaryReader binaryReader
        {
            ...
            {
                if (!canRead)
                    throw new Exception("The stream buffer can not read!");
        ...
        public BinaryWriter binaryWriter
        {
            ...
            {
                if (!canWrite)
                    throw new Exception("The stream buffer can not write!");
