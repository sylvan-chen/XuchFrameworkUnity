    ...
    public class ProtoBuildProfileSettingWindow : EditorWindow
    {
        ...
        private void OnEnable()
        {
            ...
            if (_protoBuildProfile.IgnoredDirectoryNames != null)
                _ignoredDirectoriesStr = GameUtils.ConvertArrayToStr(_protoBuildProfile.IgnoredDirectoryNames);
        }
        ...
        private void OnGUI()
        {
            ...
            _protoBuildProfile.IgnoredDirectoryNames = GameUtils.ConvertStrToArray(_ignoredDirectoriesStr);
