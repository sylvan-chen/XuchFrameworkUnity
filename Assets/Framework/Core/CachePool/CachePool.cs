...
namespace Framework.Core
{
    ...
    {
        public static float CacheExpireTime = 60f;
        ...
        public static void Update()
        {
            foreach (var collection in _cacheCollections.Values)
            {
                ...
                if (collection.IdleTime >= CacheExpireTime)
                {
        ...
        public static List<T> Acquire<T>(int count) where T : class, ICache, new()
        {
        ...
        public static void Release<T>(IEnumerable<T> caches) where T : class, ICache, new()
        {
    ...
    public class CacheCollection<T> : ICacheCollection where T : class, ICache, new()
    {
        ...
        public void Discard(int count)
        {
            ...
            if (count > _caches.Count) count = _caches.Count;
