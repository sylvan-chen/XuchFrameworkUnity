...
namespace Autohand
{
    ...
    [RequireComponent(typeof(Rigidbody)), RequireComponent(typeof(HandFollow)), RequireComponent(typeof(HandAnimator)),
     RequireComponent(typeof(HandGrabbableHighlighter)), DefaultExecutionOrder(10)]
    ...
    public class HandBase : MonoBehaviour
    {
        ...
        [EnableIf("enableMovement"),
         Tooltip("If true, the hand will forward set position and rotation to follow target, otherwise it will use physics velocity")]
        public bool forwardFollow = false;
        ...
        [AutoToggleHeader(
            ...
            0,
            tooltip =
                "Auto Posing will override Unity Animations -- This will disable all the Auto Hand IK, including animations from: finger sway, pose areas, finger bender scripts (runtime Auto Posing will still work)")]
        ...
        [HideInInspector, NonSerialized,
         Tooltip(
             "Increase for closer finger tip results / Decrease for less physics checks - The number of steps the fingers take when bending to grab something")]
        ...
        private HandFollow _handFollow;
        ...
        private HandGrabbableHighlighter _highlighter;
        ...
        private Grabbable HoldingObj = null;
        ...
        private Transform _handGrabPoint;
        ...
        private Transform _localGrabbablePoint;
        ...
        protected virtual void Awake()
        {
            ...
            foreach (var finger in fingers)
            {
                ...
                bounds.Encapsulate(
                    transform.InverseTransformPoint(finger.tip.position + (finger.tip.position - transform.position) * finger.tipRadius));
            }
