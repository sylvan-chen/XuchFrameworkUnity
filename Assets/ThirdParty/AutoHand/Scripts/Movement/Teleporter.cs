...
namespace Autohand
{
    ...
    public class Teleporter : MonoBehaviour
    {
        ...
        private void ToggleTeleportPoints(bool enable)
        {
            ...
            foreach (var tp in teleportPoints)
            {
                ...
                if (!tp.alwaysShow || enable)
                {
                    tp.gameObject.SetActive(enable);
                }
            }
        }
        ...
        public void Teleport()
        {
            ...
            if (currentTeleportPoint != null)
            {
                Vector3 finalPos = currentTeleportPoint.matchPoint ? currentTeleportPoint.teleportPoint.position : aimHit.point;

                Quaternion finalRot = currentTeleportPoint.matchDirection ? currentTeleportPoint.teleportPoint.rotation :
