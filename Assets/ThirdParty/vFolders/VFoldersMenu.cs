...
namespace VFolders
{
    class VFoldersMenu
    {
        ...
        public static bool navigationBarEnabled {get => VFoldersSettings.NavigationBarEnabled; set => VFoldersSettings.NavigationBarEnabled = value;}
        public static bool twoLineNamesEnabled { get => VFoldersSettings.TwoLineNamesEnabled; set => VFoldersSettings.TwoLineNamesEnabled = value; }
        public static bool autoIconsEnabled { get => VFoldersSettings.AutoIconsEnabled; set => VFoldersSettings.AutoIconsEnabled = value; }
        public static bool hierarchyLinesEnabled { get => VFoldersSettings.HierarchyLinesEnabled; set => VFoldersSettings.HierarchyLinesEnabled = value; }
        public static bool zebraStripingEnabled { get => VFoldersSettings.ZebraStripingEnabled; set => VFoldersSettings.ZebraStripingEnabled = value; }
        public static bool contentMinimapEnabled { get => VFoldersSettings.ContentMinimapEnabled; set => VFoldersSettings.ContentMinimapEnabled = value; }
        public static bool backgroundColorsEnabled { get => VFoldersSettings.BackgroundColorsEnabled; set => VFoldersSettings.BackgroundColorsEnabled = value; }
        public static bool minimalModeEnabled { get => VFoldersSettings.MinimalModeEnabled; set => VFoldersSettings.MinimalModeEnabled = value; }
        public static bool foldersFirstEnabled { get => VFoldersSettings.FoldersFirstEnabled; set => VFoldersSettings.FoldersFirstEnabled = value; }
        public static bool toggleExpandedEnabled { get => VFoldersSettings.ToggleExpandedEnabled; set => VFoldersSettings.ToggleExpandedEnabled = value; }
        public static bool collapseEverythingElseEnabled { get => VFoldersSettings.CollapseEverythingElseEnabled; set => VFoldersSettings.CollapseEverythingElseEnabled = value; }
        public static bool collapseEverythingEnabled { get => VFoldersSettings.CollapseEverythingEnabled; set => VFoldersSettings.CollapseEverythingEnabled = value; }
        public static bool pluginDisabled { get => VFoldersSettings.PluginDisabled; set => VFoldersSettings.PluginDisabled = value; }
        ...
        static void OpenSettings() => Selection.activeObject = VFoldersSettings.Instance;
