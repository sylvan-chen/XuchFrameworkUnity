    ...
    : ISearchFilterable
{
    ...
    [Tooltip("The list of blacklisted asset names. If an asset name contains any of these strings, it will be ignored.")]
    ...
    [Tooltip("Group all assets that match this rule into a single group.")]
    [Label("Group Togethor")]
    public bool groupTogethor = true;

    [Tooltip("If true, the asset will be marked as local.")]
    [Label("Is Local")]
